...
Description: Adds A Fading Transition Effect To The WordPress Login Page, Administration Pannel, and Your Website! Similar To AJAX... But Done With jQuery! 
...
function transitions() {
    ...
    add_options_page('<img src="../wp-content/plugins/transitions/transitions.sb.png"/> Transitions', '<img src="../wp-content/plugins/transitions/transitions.sb.png"/> Transitions', 8, 'transitionswp', 'transitions_wp');
...
<h2><img src="<?php bloginfo('url'); ?>/wp-content/plugins/transitions/transitions.png"/>  Transitions v0.1 alpha - Fading Page jQuery Plugin</h2>
<p>Options, and Effects Coming Very Soon!!</p>
